# نشر أكاديمية الإمام v9.1.0 — إصدار الاستقرار

## قبل الترقية

> إذا كنت رفعت v9.0.0 المعطوبة، ارفع **كل ملفات 9.1.0** مع الاستبدال. الكاش الجديد `quran-pwa-v9.1.0` و`skipWaiting` يساعدان على استبدال النسخة القديمة سريعًا؛ افتح الموقع مرة أخرى بعد اكتمال رفع GitHub Pages.
